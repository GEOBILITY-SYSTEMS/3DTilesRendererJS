...
class Tn {
  ...
  async parseToMesh(e, t, s, n, i) {
    ...
    y && ([m, f, p] = y, h = y[3], d = y[7]);
    const g = new rn(2 * h, 2 * d), x = new Se(g, new _e({ map: u, transparent: !0 }));
    x.position.set(m, f, p);
    const T = r.tiling.getTileContentUVBounds(o, l, c), { uv: _ } = g.attributes;
    for (let S = 0; S < _.count; S++)
      me.fromBufferAttribute(_, S), me.x = M.mapLinear(me.x, 0, 1, T[0], T[2]), me.y = M.mapLinear(me.y, 0, 1, T[1], T[3]), _.setXY(S, me.x, me.y);
    return x;
  }
  preprocessNode(e) {
  ...
  createBoundingVolume(e, t, s) {
    ...
    let m = (h - c) / 2, f = (d - u) / 2, p = c + m, y = u + f;
    return n && (p -= 0.5, y -= 0.5), i ? (p *= o * i, m *= o * i, y *= l * i, f *= l * i) : (p *= r.aspectRatio, m *= r.aspectRatio), {
      box: [
        // center
        p,
        y,
...
const Ei = 30, wi = 15, _t = /* @__PURE__ */ new v(), os = /* @__PURE__ */ new v(), ie = /* @__PURE__ */ new X(), St = /* @__PURE__ */ new pe();
class gt extends Tn {
  get projection() {
  ...
  async parseToMesh(e, t, ...s) {
    ...
    if (i === "ellipsoid") {
      const c = o.ellipsoid, u = t[le], h = t[Te], d = t[be], [m, f, p, y] = t.boundingVolume.region, g = Math.ceil((y - f) * M.RAD2DEG * 0.25), x = Math.ceil((p - m) * M.RAD2DEG * 0.25), b = Math.max(wi, g), T = Math.max(Ei, x), _ = new rn(1, 1, T, b), [S, C, A, P] = l.getTileBounds(h, d, u, !0, !0), R = l.getTileContentUVBounds(h, d, u), { position: V, normal: k, uv: W } = _.attributes, Q = V.count;
      ...
      for (let H = 0; H < Q; H++) {
        ...
        if (r.isMercator && this.endCaps && (P === 1 && ie.y === 1 && (I = Math.PI / 2), C === 0 && ie.y === 0 && (I = -Math.PI / 2)), r.isMercator && ie.y !== 0 && ie.y !== 1) {
          const E = r.convertNormalizedToLatitude(1), N = 1 / b, K = M.mapLinear(ie.y - N, 0, 1, f, y), F = M.mapLinear(ie.y + N, 0, 1, f, y);
  ...
  createChild(...e) {
    ...
    if (t && s === "ellipsoid") {
      ...
      const [c, u, h, d] = i.getTileBounds(o, l, r, !0), { tilePixelWidth: m, tilePixelHeight: f } = i.getLevel(r), p = (h - c) / m, y = (d - u) / f, [
        /* west */
        ,
        g,
        x,
...
class _n {
  ...
  generateLevels(e, t, s, n = {}) {
    ...
    for (let h = i; h < e; h++) {
      const d = e - h - 1, m = Math.ceil(c * 2 ** -d), f = Math.ceil(u * 2 ** -d), p = Math.ceil(m / r), y = Math.ceil(f / o);
      this.setLevel(h, {
        tilePixelWidth: r,
        tilePixelHeight: o,
        pixelWidth: m,
  ...
  getTilesInRange(e, t, s, n, i, r = !1) {
    ...
    const { tileCountX: y, tileCountY: g } = this.getLevel(i), [x, b] = f, [T, _] = p;
  ...
  getTileBounds(e, t, s, n = !1, i = !0) {
    ...
    let f = c * e - o, p = u * t - o, y = f + c + o * 2, g = p + u + o * 2;
    if (f = Math.max(f, 0), p = Math.max(p, 0), y = Math.min(y, h), g = Math.min(g, d), f = f / h, y = y / h, p = p / d, g = g / d, r) {
...
class Sn extends Ge {
  ...
  constructor(e = {}) {
    const {
      ...
      levels: d = 20,
      tileDimension: m = 256,
      contentBoundingBox: f = null,
      ...p
    } = e;
    super(p), this.capabilities = t, this.layer = s, this.tileMatrixSet = n, this.style = i, this.url = r, this.format = o, this.dimensions = l, this.tileMatrixLabels = c, this.tileMatrices = u, this.projection = h, this.levels = d, this.tileDimension = m, this.contentBoundingBox = f, this._useKvp = !1;
  }
  /**
  ...
  init() {
    ...
    if (e.flipY = !0, e.setProjection(new re(u)), i !== null ? e.setContentBounds(
      ...
      const m = h.tileWidth || t, f = h.tileHeight || t;
      e.setLevel(d, {
        tilePixelWidth: m,
        tilePixelHeight: f,
...
class Mn extends Ge {
  ...
  getUrl(e, t, s) {
    ...
    if (r === "EPSG:3857") {
      ...
      r === "EPSG:4326" ? u === "1.1.1" ? m = [p, y, g, x] : m = [y, p, x, g] : m = [p, y, g, x];
    }
...
class Bi extends jn {
  ...
  parse(e) {
    ...
    const b = "octvertexnormals" in p, T = b || r, _ = m.u.length, S = [], C = [], A = [], P = [];
    let R = 0, V = 0;
    for (let L = 0; L < _; L++)
    ...
    function W(L, I) {
      return I.x = m.u[L], I.y = m.v[L], I.z = m.height[L], I;
    }
    ...
    function H(L) {
      ...
      const K = L.length - 1;
      for (let G = 0; G < K; G++) {
        const D = G, Z = G + 1, fe = G + L.length, xt = G + L.length + 1;
        N.push(D, fe, Z), N.push(Z, fe, xt);
      }
      let F = null;
      if (T) {
        ...
        if (i) {
          ...
          for (let fe = 0, xt = G / 2; fe < xt; fe++) {
            const Tt = L[fe], Me = 3 * fe, ts = D[3 * Tt + 0], ss = D[3 * Tt + 1], ns = D[3 * Tt + 2];
...
const z = 0, ue = ["a", "b", "c"], w = /* @__PURE__ */ new ke(), cs = /* @__PURE__ */ new ke(), us = /* @__PURE__ */ new ke(), hs = /* @__PURE__ */ new ke();
class Cn {
  constructor() {
  ...
  getClippedData(e, t = null, s = {}) {
    ...
    function f(p, y) {
      for (let g = 0; g < 3; g++) {
        ...
        x in h || (h[x] = u, u++, p.getVertexData(g, y, s.attributes), s.vertexIsClipped.push(p.clipValues[ue[g]] === z));
        const b = h[x];
        s.index.push(b);
      }
    }
...
const ps = {}, Ui = /* @__PURE__ */ new v(), Mt = /* @__PURE__ */ new v(), Ct = /* @__PURE__ */ new v(), Ni = /* @__PURE__ */ new v(), Vi = /* @__PURE__ */ new v(), Y = /* @__PURE__ */ new v(), Ce = /* @__PURE__ */ new v(), j = /* @__PURE__ */ new X(), ce = /* @__PURE__ */ new X(), fs = /* @__PURE__ */ new X();
class Fi extends Cn {
  constructor() {
  ...
  clipToQuadrant(e, t, s) {
    ...
    if (i > 0) {
      ...
      for (let k = 0; k < V; k++) {
        ...
        for (let Q = 0; Q < 3; Q++) {
          ...
          if (j.fromArray(A, L * 2), ce.fromArray(A, I * 2), j.x === ce.x && (j.x === 0 || j.x === 0.5 || j.x === 1) || j.y === ce.y && (j.y === 0 || j.y === 0.5 || j.y === 1)) {
            Mt.fromArray(P, L * 3), Ct.fromArray(P, I * 3);
            const B = Mt, O = Ct, E = Ni.copy(Mt), N = Vi.copy(Ct);
            Y.copy(E).add(e.position), r.getPositionToNormal(Y, Y), E.addScaledVector(Y, -i), Y.copy(N).add(e.position), r.getPositionToNormal(Y, Y), N.addScaledVector(Y, -i), o && R ? (Y.fromArray(R, L * 3), Ce.fromArray(R, I * 3)) : (Y.subVectors(B, O), Ce.subVectors(B, E).cross(Y).normalize(), Y.copy(Ce)), S(O, ce, Ce), S(B, j, Y), S(E, j, Y), S(O, ce, Ce), S(E, j, Y), S(N, ce, Ce);
          }
        }
      }
    }
    ...
    if (l) {
      const { index: T, attributes: _ } = l, S = m.attributes.position.length / 3;
      for (let C = 0, A = T.length; C < A; C++)
        m.index.push(T[C] + S);
      for (const C in h.attributes)
        m.attributes[C].push(..._[C]);
    }
    if (c) {
      const { index: T, attributes: _ } = c, S = m.attributes.position.length / 3;
      for (let C = 0, A = T.length; C < A; C++)
        m.index.push(T[C] + S);
      for (const C in h.attributes)
        m.attributes[C].push(..._[C]);
    }
    const f = t ? 0 : -0.5, p = s ? 0 : -0.5, y = m.attributes.uv;
    for (let T = 0, _ = y.length; T < _; T += 2)
      y[T] = (y[T] + f) * 2, y[T + 1] = (y[T + 1] + p) * 2;
  ...
  adjustVertices(e, t, s) {
    ...
    for (let f = 0; f < m; f++) {
      ...
      const y = M.lerp(i, r, p.y), g = M.lerp(o, l, p.x), x = Ui.fromArray(h, f * 3).add(t);
      n.getPositionToCartographic(x, ps), n.getCartographicToPosition(y, g, ps.height + s, x), x.sub(t), x.toArray(h, f * 3);
    }
  }
}
function ms(a) {
  return (e, t, s, n, i) => {
    ...
    return j.fromBufferAttribute(r, t), ce.fromBufferAttribute(r, s), fs.fromBufferAttribute(r, n), j[a] * i.x + ce[a] * i.y + fs[a] * i.z - 0.5;
  };
}
const gs = Symbol("TILE_X"), ys = Symbol("TILE_Y"), Oe = Symbol("TILE_LEVEL"), ge = Symbol("TILE_AVAILABLE"), It = Symbol("TILE_SPLIT_SOURCE_SCENE"), Ye = 1e4, xs = /* @__PURE__ */ new v();
function ki(a, e, t, s) {
  if (a && e < a.length) {
    const n = a[e];
...
class Hi {
  ...
  loadRootTileset() {
    ...
    return e.invokeAllPlugins((s) => t = s.preprocessURL ? s.preprocessURL(t, null) : t), e.invokeOnePlugin((s) => s.fetchData && s.fetchData(t, this.tiles.fetchOptions)).then((s) => s.json()).then((s) => {
      ...
      let p = c.rootURL;
      return c.invokeAllPlugins((y) => p = y.preprocessURL ? y.preprocessURL(p, null) : p), c.preprocessTileset(f, p), f;
    });
  }
  parseToMesh(e, t, s, n) {
    const {
    ...
    return t.boundingVolume.region[4] = d, t.boundingVolume.region[5] = m, t.engineData.boundingVolume.setRegionData(u, ...t.boundingVolume.region), f && ("geometricerror" in f && (t.geometricError = f.geometricerror), At(t, this.layer) && "available" in f && t.children.length === 0 && (t[ge] = [
  ...
  createChild(e, t, s, n) {
    const { tiles: i, layer: r, tiling: o, projection: l } = this, c = i.ellipsoid, u = n === null && e === 0 || ki(n, e, t, s), h = zi(t, s, e, 1, r), d = [...o.getTileBounds(t, s, e), -Ye, Ye], [
      ...
      ,
      p
    ] = d, y = m > 0 != f > 0 ? 0 : Math.min(Math.abs(m), Math.abs(f));
    ...
    return At(_, r) || (_[ge] = n), _;
  }
  expandChildren(e) {
    const t = e[Oe], s = e[gs], n = e[ys], i = e[ge];
  ...
  disposeTile(e) {
    ...
    if (delete e[It], At(e, s) && (e[ge] = null), ge in e) {
  ...
  processTileModel(e, t) {
    ...
    e.traverse((d) => {
      ...
      if (d.geometry) {
        ...
        if (r) {
          const { uv: p, uv1: y, uv2: g, uv3: x } = f;
          p && (f.uv = we(p, c)), y && (f.uv1 = we(y, c)), g && (f.uv2 = we(g, c)), x && (f.uv3 = we(x, c));
        }
        if (s && !f.normals && m.computeVertexNormals(), o && f.normals && (f.normals = we(f.normals, u)), l && qi(d, h), i && m.index) {
          const p = f.position.count, y = m.index, g = p > 65535 ? Uint32Array : p > 255 ? Uint16Array : Uint8Array;
...
class nr extends Jt {
  ...
  getPropertyValuesAtTexel(e, t, s, n, i = []) {
    ...
    for (let d = 0, m = e.length; d < m; d++) {
      ...
      if (!o[f])
        continue;
      const p = l[f], y = r[p.index];
      En(n, p.texCoord, s, c, Is), wn(Is, y.image.width, y.image.height, As), Ls.set(d, 0), de.renderPixelToTarget(y, As, Ls);
    }
...
class vs {
  constructor(e, t, s, n = null, i = null) {
    ...
    let m = [], f = [];
    n && (n.propertyTextures && (m = n.propertyTextures.map((p) => new nr(l[p], h, u, t))), n.propertyAttributes && (f = n.propertyAttributes.map((p) => new Zi(c[p], h, u)))), this.schema = r, this.tableAccessors = d, this.textureAccessors = m, this.attributeAccessors = f, this.object = i, this.textures = t, this.nodeMetadata = n;
  }
  // Property Tables
  /**
...
class or {
  ...
  async afterRoot({ scene: e, parser: t }) {
    ...
    if (i.schemaUri) {
      const { manager: c, path: u, requestHeader: h, crossOrigin: d } = t.options, m = new URL(i.schemaUri, u).toString(), f = new li(c);
...
class lr {
  ...
  getFeatures(e, t) {
    ...
    for (let d = 0, m = i.length; d < m; d++) {
      ...
      if ("texture" in f) {
        const y = n[f.texture.index];
        En(s, f.texture.texCoord, t, l, Es), wn(Es, y.image.width, y.image.height, ws), Ps.set(d, 0), de.renderPixelToTarget(n[f.texture.index], ws, Ps);
      } else if ("attribute" in f) {
        const g = s.getAttribute(`_feature_id_${f.attribute}`).getX(c);
        g !== p && (r[d] = g);
      } else {
        const y = c;
        y !== p && (r[d] = y);
    ...
    function h() {
      ...
      for (let m = 0, f = i.length; m < f; m++) {
        const p = i[m], y = "nullFeatureId" in p ? p.nullFeatureId : null;
        if ("texture" in p) {
          const { channels: g } = p.texture, x = g.map((T) => u[4 * m + T]);
...
function xr() {
  ...
  if (s !== 0 && c !== 0 && (i.dispatchEvent({ type: "fade-change" }), i.dispatchEvent({ type: "needs-render" })), t || i.visibleTiles.forEach((u) => {
    ...
    l.forEach((h) => {
      ...
      d.decompose(Os, Ns, Vs), m.decompose(Ds, Us, Vs);
      const f = Ns.angleTo(Us), p = Os.distanceTo(Ds);
      u = u && (f > 0.25 || p > 0.1);
  ...
  if (l.forEach((u) => {
    ...
    i.markTileUsed(u), m && (e.setFade(m, h, d), f && (m.visible = !0)), this.forEachBatchIds(u, (p, y, g) => {
...
class br extends Tr {
  ...
  raycastInstance(e, t, s) {
    ...
    ee.geometry.setDrawRange(r.start, r.count), ee.geometry.boundingBox === null && (ee.geometry.boundingBox = new mt()), ee.geometry.boundingSphere === null && (ee.geometry.boundingSphere = new pe()), this.getMatrixAt(e, ee.matrixWorld).premultiply(this.matrixWorld), this.getBoundingBoxAt(i, ee.geometry.boundingBox), this.getBoundingSphereAt(i, ee.geometry.boundingSphere), ee.raycast(t, Qe);
  ...
  addSceneToBatchedMesh(e, t) {
    ...
    if (n && i) {
      ...
      this._tileToInstanceId.set(t, r), s.forEach((o) => {
        ...
        r.push(m), u.setMatrixAt(m, o.matrixWorld), u.setVisibleAt(m, !1), _r(c.color) || (c.color.setHSL(Math.random(), 0.5, 0.5), u.setColorAt(m, c.color));
        const f = c.map;
        f ? this.assignTextureToLayer(f, m) : this.assignTextureToLayer(Ht, m);
...
const Rt = /* @__PURE__ */ new pe(), Ke = /* @__PURE__ */ new v(), Be = /* @__PURE__ */ new J(), Gs = /* @__PURE__ */ new J(), Bt = /* @__PURE__ */ new di(), Mr = /* @__PURE__ */ new _e({ side: at }), zs = /* @__PURE__ */ new mt(), Dt = 1e5;
function Hs(a, e) {
    ...
    r.updateMatrixWorld(!0), r.traverse((o) => {
      ...
      l && (Be.copy(o.matrixWorld), r.parent !== null && Be.premultiply(i.group.matrixWorldInverse), Gs.copy(Be).invert(), Hs(l, Rt).applyMatrix4(Be), n.forEach(({
        ...
        for (let x = 0, b = y.count; x < b; x++) {
          ...
          if (T) {
            let _ = (Dt - T.distance) / m;
            const S = _ >= 1;
            (!S || S && d === "flatten") && (_ = Math.min(_, 1), T.point.addScaledVector(g.direction, M.mapLinear(_, 0, 1, -f, 0)), T.point.applyMatrix4(Gs), y.setXYZ(x, ...T.point));
          }
        }
      }));
...
function qs(a, e, t = null, s = null, n = null) {
  ...
  const h = [], d = new J();
  if (a.forEach((m) => {
    d.copy(m.matrixWorld), t && d.premultiply(t);
    const { uv: f, region: p } = Ir(m.geometry, d, e);
    h.push(f), i = Math.min(i, p[1]), l = Math.max(l, p[3]), r = Math.min(r, p[0]), c = Math.max(c, p[2]), o = Math.min(o, p[4]), u = Math.max(u, p[5]);
  }), s !== null) {
    ...
    h.forEach((g) => {
      for (let x = 0, b = g.length; x < b; x += 3) {
        ...
        C = M.clamp(C, 0, 1), A = M.clamp(A, 0, 1), g[x + 0] = M.mapLinear(C, m, p, 0, 1), g[x + 1] = M.mapLinear(A, f, y, 0, 1), g[x + 2] = M.mapLinear(S, o, u, 0, 1);
      }
    });
  }
  return {
...
function Lr(a, e) {
  ...
  return a.forEach((u) => {
    ...
    for (let h = 0, d = u.length; h < d; h += 3) {
      ...
      u[h + 0] = M.mapLinear(m, t, i, 0, 1), u[h + 1] = M.mapLinear(f, s, r, 0, 1);
    }
  }), {
    uvs: l,
    range: [t, s, i, r],
...
class Rn {
  ...
  draw(e, t) {
    const { canvas: s, range: n, context: i } = this, { width: r, height: o } = s, { image: l } = e, c = Math.round(M.mapLinear(t[0], n[0], n[2], 0, r)), u = Math.round(M.mapLinear(t[1], n[1], n[3], 0, o)), h = Math.round(M.mapLinear(t[2], n[0], n[2], 0, r)), d = Math.round(M.mapLinear(t[3], n[1], n[3], 0, o)), m = h - c, f = d - u;
...
class Er extends Bn {
  ...
  async fetchItem([e, t, s, n, i], r) {
    const { tiledImageSource: o, tileComposer: l, IS_DIRECT_TILE: c, LOCK_TOKENS: u } = this, h = [e, t, s, n], d = o.tiling, m = [...h, i];
    await this._markImages(h, i, !1);
    let f = null, p = 0;
    if (Ze(h, i, d, (x, b, T) => {
      p++, f = [x, b, T];
    }), p === 1) {
      const [x, b, T] = f, _ = d.getTileBounds(x, b, T, !0, !1);
      if (Math.abs(_[0] - e) <= Je && Math.abs(_[1] - t) <= Je && Math.abs(_[2] - s) <= Je && Math.abs(_[3] - n) <= Je) {
        const S = o.get(x, b, T).clone();
        return S[c] = !0, S[u] = m, S;
      }
    }
    const y = document.createElement("canvas");
    y.width = this.resolution, y.height = this.resolution;
    const g = new Qt(y);
    return g.colorSpace = Xt, g.generateMipmaps = !1, g[u] = m, l.setTarget(g, h), l.clear(16777215, 0), Ze(h, i, d, (x, b, T) => {
...
class Pr extends Bn {
  ...
  _drawToCanvas(e, t) {
    ...
    for (let y = 0; y < c.length; y++) {
      const g = c[y];
      this._featureIntersectsTile(g, f) && this._drawFeatureOnCanvas(p, g, f, e.width, e.height);
    }
  }
  ...
  _drawFeatureOnCanvas(e, t, s, n, i) {
    ...
    if (b === "Point") {
      ...
      e.beginPath(), e.ellipse(S, C, f / A, f, 0, 0, Math.PI * 2), e.fill(), e.stroke();
...
class Mo {
  ...
  _getSplitVectors(e, t, s = Nt) {
    ...
    i.forEach(({ tileInfo: u }, h) => {
      ...
      if (d && d.target && h.shouldSplit(d.range, t)) {
        ...
        const f = tt.set(0, 0, 1);
        Math.abs(se.dot(f)) > 1 - 1e-4 && f.set(1, 0, 0);
        const p = new v().crossVectors(se, f).normalize(), y = new v().crossVectors(se, p).normalize();
        o.push(p, y);
      }
    });
    const c = [];
  ...
  async expandVirtualChildren(e, t) {
    ...
    c.attributeList = (h) => !/^layer_uv_\d+/.test(h), o.map((h) => {
      c.addSplitOperation((d, m, f, p, y, g) => ($t.getInterpolatedAttribute(d.attributes.position, m, f, p, y, tt), tt.applyMatrix4(g).sub(Nt).dot(h)));
    });
    const u = [];
    c.forEachSplitPermutation(() => {
      ...
      if (h.traverse((f) => {
        ...
        return;
      const m = {};
      if (t.boundingVolume.region && (m.region = qs(d, this.tiles.ellipsoid).region), t.boundingVolume.box || t.boundingVolume.sphere) {
  ...
  _initTileOverlayInfo(e, t = this.overlays) {
    ...
    if (s.get(t).tileInfo.set(e, n), t.isReady && !t.isPlanarProjection) {
      if (e.boundingVolume.region) {
        ...
        let c = [i, r, o, l];
        c = t.projection.clampToBounds(c), c = t.projection.toNormalizedRange(c), n.range = c, t.lockTexture(c, e);
      }
    }
  }
  ...
  async _initTileSceneOverlayInfo(e, t, s = this.overlays) {
    ...
    if (s.isPlanarProjection) {
      Ie.makeScale(1 / m, 1, 1).multiply(s.frame), e.parent !== null && Ie.multiply(n.group.matrixWorldInverse);
      let T;
      ({ range: y, uvs: g, heightRange: T } = Lr(d, Ie)), x = !(T[0] > 1 || T[1] < 0);
    } else
      Ie.identity(), e.parent !== null && Ie.copy(n.group.matrixWorldInverse), { range: y, uvs: g } = qs(d, l, Ie, f, p.range), x = !0;
    p.range === null && (p.range = y, s.lockTexture(y, t));
    let b = null;
    x && s.hasContent(y, t) && (b = await o.add({ tile: t, overlay: s }, async () => {
      if (c.signal.aborted || h.signal.aborted)
        return null;
      const T = await s.getTexture(y, t);
...
function On(a, { computeNormals: e = !1 } = {}) {
  ...
  for (let d = 0, m = u.count; d < m; d++) {
    ...
    let y = r;
    a.getCartographicToNormal(f, p, Ft), ne.z < 0 && (y = o), a.getCartographicToPosition(f, p, y, ne), u.setXYZ(d, ...ne);
  }
  e && l.computeVertexNormals();
  for (let d = 0, m = h.count; d < m; d++) {
    ne.fromBufferAttribute(h, d);
    const f = M.mapLinear(ne.x, -0.5, 0.5, t, s), p = M.mapLinear(ne.y, -0.5, 0.5, n, i);
    Ft.fromBufferAttribute(c, d), a.getCartographicToNormal(f, p, it), Math.abs(Ft.dot(it)) > 0.1 && (ne.z > 0 && it.multiplyScalar(-1), c.setXYZ(d, ...it));
  }
  return l;
}
class Or extends dn {
...
const $s = Symbol("ORIGINAL_MATERIAL"), rt = Symbol("HAS_RANDOM_COLOR"), ot = Symbol("HAS_RANDOM_NODE_COLOR"), kt = Symbol("LOAD_TIME"), ye = Symbol("PARENT_BOUND_REF_COUNT"), Qs = /* @__PURE__ */ new pe(), Ae = () => {
}, Gt = {};
function xe(a) {
  if (!Gt[a]) {
...
class Oo {
  ...
  update() {
    ...
    let c;
    (t === lt || s === lt) && (c = Array.from(l).sort((m, f) => m[kt] - f[kt]));
    const u = (m, f, p, y, g, x) => {
      switch (m !== Ue && delete p.material[rt], m !== Ne && delete p.material[ot], m) {
        case Fn: {
        ...
        case Ks: {
          p.material.color.copy(xe(f.internal.depth)), delete p.material[rt], delete p.material[ot];
          break;
        }
      }
    };
    l.forEach((m) => {
      ...
      let p, y, g;
      t === Ue && (p = Math.random(), y = 0.5 + Math.random() * 0.5, g = 0.375 + Math.random() * 0.25), f.traverse((x) => {
        t === Ne && (p = Math.random(), y = 0.5 + Math.random() * 0.5, g = 0.375 + Math.random() * 0.25), x.material && u(t, m, x, p, y, g);
      });
    });
    ...
    for (const m of d)
      for (const f of m.children) {
        ...
        let y, g, x;
        h === Ue && (y = Math.random(), g = 0.5 + Math.random() * 0.5, x = 0.375 + Math.random() * 0.25), f.traverse((b) => {
  ...
  _createBoundHelper(e) {
    ...
    if (i) {
      ...
      const l = new gi(i.box, xe(e.internal.depth));
    ...
    if (n) {
      const o = new Br(n, xe(e.internal.depth));
    ...
    if (r) {
      const o = new Or(r, xe(e.internal.depth));
      o.raycast = Ae, o.userData.tile = e;
      const l = new Ur(r, xe(e.internal.depth));
...
class No extends xn {
  parse(e) {
    const t = new TextDecoder("utf-8").decode(new Uint8Array(e)), s = new DOMParser().parseFromString(t, "text/xml"), n = s.querySelector("Contents"), i = he(n, "TileMatrixSet").map((l) => Wr(l)), r = he(n, "Layer").map((l) => Gr(l)), o = kr(s.querySelector("ServiceIdentification"));
    return r.forEach((l) => {
...
function Gr(a) {
  const e = a.querySelector("Title").textContent, t = a.querySelector("Identifier").textContent, s = a.querySelector("Format").textContent, n = he(a, "ResourceURL").map((c) => zr(c)), i = he(a, "TileMatrixSetLink").map((c) => he(c, "TileMatrixSet")[0].textContent), r = he(a, "Style").map((c) => qr(c)), o = he(a, "Dimension").map((c) => Hr(c));
...
function Wr(a) {
  ...
  return a.querySelectorAll("TileMatrix").forEach((l, c) => {
    const u = jr(l), h = 28e-5 * u.scaleDenominator, d = u.tileWidth * u.matrixWidth * h, m = u.tileHeight * u.matrixHeight * h;
    let f;
    Wt(u.topLeftCorner, e), Hn(e) ? f = [
      u.topLeftCorner[0] + d,
      u.topLeftCorner[1] - m
    ] : f = [
      u.topLeftCorner[0] + 360 * d / dt,
      u.topLeftCorner[1] - 360 * m / dt
    ], pt(f, e), pt(u.topLeftCorner, e), ft(f), ft(u.topLeftCorner), u.bounds = [...u.topLeftCorner, ...f], [u.bounds[1], u.bounds[3]] = [u.bounds[3], u.bounds[1]], i.push(u);
  }), {
    title: t,
    identifier: s,
    abstract: n,
...
function qn(a, e, t = {}) {
  ...
  const l = ((p = a.querySelector(":scope > Name")) == null ? void 0 : p.textContent) || null, c = ((y = a.querySelector(":scope > Title")) == null ? void 0 : y.textContent) || "", u = ((g = a.querySelector(":scope > Abstract")) == null ? void 0 : g.textContent) || "", h = [...a.querySelectorAll(":scope > Keyword")].map((x) => x.textContent), m = [...a.querySelectorAll(":scope > BoundingBox")].map((x) => $r(x, e));
  n = [
    ...n,
  ...
  const f = Array.from(a.querySelectorAll(":scope > Layer")).map((x) => qn(x, e, {
    // add
    styles: s,
    crs: n,
    // replace
...
//# sourceMappingURL=WMSCapabilitiesLoader-DQBZHaub.js.map
