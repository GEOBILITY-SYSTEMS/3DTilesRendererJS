...
var CesiumIonAuth = class {
	...
	async fetch(e, t) {
		...
		let n = { ...t };
		n.headers = n.headers || {}, n.headers = {
			...n.headers,
			Authorization: this._bearerToken
		};
		let r = await fetch(e, n);
		return r.status >= 400 && r.status <= 499 && this.autoRefreshToken ? (await this.refreshToken(t), n.headers.Authorization = this._bearerToken, fetch(e, n)) : r;
	}
	refreshToken(e) {
