...
var we = /* @__PURE__ */ new me(), E = /* @__PURE__ */ new T(), D = /* @__PURE__ */ new T(), Te = /* @__PURE__ */ new T(), O = /* @__PURE__ */ new S(), k = /* @__PURE__ */ new S(), Ee = /* @__PURE__ */ new pe(), A = /* @__PURE__ */ new _(), De = /* @__PURE__ */ new T(), Oe = /* @__PURE__ */ new T(), ke = /* @__PURE__ */ new T(), Ae = /* @__PURE__ */ new T(), je = /* @__PURE__ */ new ue(), Me = 1e-12, Ne = .1, Pe = 0, Fe = 1, Ie = 2, Ellipsoid = class {
	...
	getCartographicToPosition(e, t, n, r) {
		this.getCartographicToNormal(e, t, E);
		let i = this.radius;
		D.copy(E), D.x *= i.x ** 2, D.y *= i.y ** 2, D.z *= i.z ** 2;
		let a = Math.sqrt(E.dot(D));
		return D.divideScalar(a), r.copy(D).addScaledVector(E, n);
	}
			...
			if (n) {
				...
				n.forEach((e) => {
					if (!r.has(e)) {
						...
						t.traverse((e) => {
							e.updateMatrix(), e.matrixWorld.copy(e.matrix), e.parent ? e.matrixWorld.premultiply(e.parent.matrixWorld) : e.matrixWorld.premultiply(this.matrixWorld);
						});
					}
				});
			}
...
var Qe = /* @__PURE__ */ new T(), $e = /* @__PURE__ */ new T(), j = /* @__PURE__ */ new T(), et = /* @__PURE__ */ new ue(), OBB = class {
	...
	distanceToPoint(e) {
		return this.clampPoint(e, j).distanceTo(e);
	}
	containsPoint(e) {
...
var TilesRenderer = class extends i {
	...
	setTileActive(e, t) {
		let n = e.engineData.scene, r = this.group;
		n && n.traverse((e) => {
			e.updateMatrix(), e.matrixWorld.copy(e.matrix), e.parent ? e.matrixWorld.premultiply(e.parent.matrixWorld) : e.matrixWorld.premultiply(r.matrixWorld);
		}), super.setTileActive(e, t);
	}
	setTileVisible(e, t) {
		let n = e.engineData.scene, r = this.group;
		t ? n && r.add(n) : n && r.remove(n), super.setTileVisible(e, t);
	}
